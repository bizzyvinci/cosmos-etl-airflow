...
def read_export_dag_vars(var_prefix, **kwargs):
    ...
    vars = {
        ...
        'export_blocks_toggle': parse_bool(read_var('export_blocks_toggle', var_prefix, False, **kwargs)),
        'export_transactions_and_events_toggle': parse_bool(read_var('export_transactions_and_events_toggle', var_prefix, False, **kwargs)),
    }
    return vars
...
def read_var(var_name, var_prefix=None, required=False, **kwargs):
    ...
    # Looks redundant, should be able to set default as None
